...
namespace RaceFatal.Content
{
    ...
    public class GameContentCatalogSO : ScriptableObject
    {
        ...
        public IReadOnlyList<BikeBuildDefinitionSO> BikeBuildDefinitions => bikeBuildDefinitions;
        public IReadOnlyList<EquipmentDefinitionSO> EquipmentDefinitions => equipmentDefinitions;
        public IReadOnlyList<RacerDefinitionSO> RacerDefinitions => racerDefinitions;
        public IReadOnlyList<OpponentTeamDefinitionSO> OpponentTeamDefinitions => opponentTeamDefinitions;
        ...
        public BikeDefinitionSO FindBikeContent(string id)
        {
            if (string.IsNullOrWhiteSpace(id))
                return null;
        ...
        public RacerDefinitionSO FindRacerContent(string id)
        {
            if (string.IsNullOrWhiteSpace(id))
                return null;
