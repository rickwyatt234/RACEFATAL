...
{
    public class UnityRaceInputService : MonoBehaviour, IRaceInputService
    {
        ...
        [SerializeField] private KeyCode steeringLeftKey = KeyCode.A;
        [SerializeField] private KeyCode steeringRightKey = KeyCode.D;
        ...
        public bool EquipmentPressed =>
            UnityEngine.Input.GetMouseButtonDown(activationMouseButton);

        public bool EquipmentReleased =>
            UnityEngine.Input.GetMouseButtonUp(activationMouseButton);

        public bool NextEquipmentPressed =>
            UnityEngine.Input.GetKeyDown(nextEquipment);
        ...
        public float Throttle =>
            UnityEngine.Input.GetKey(throttleKey) ? 1f : 0f;
        ...
        public float Steering
        {
            get
            {
                ...
                if (UnityEngine.Input.GetKey(steeringLeftKey))
                    value -= 1f;

                if (UnityEngine.Input.GetKey(steeringRightKey))
                    value += 1f;
